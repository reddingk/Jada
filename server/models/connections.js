...
/*
  connectionId | nickname | token | socket | connection | location
*/
...
class JConnection {
    ...
    addConnection(id, conn, nickname, token, isSub) {
        ...
        try {
            ...
            log.error("Adding Connection: " + ex); status = false;
        }
        return status;
    }
    ...
    removeConnection(id) {
        ...
        try {
            ...
            log.error("Removing Connection [" + id + "]:" + ex); status = false;
        }
        return status;
    }
    ...
    clearConnection(id) {
        ...
        try {
            ...
            log.error("Clearing Connection [" + id + "]:" + ex); status = false;
        }
        return status;
    }
    ...
    addSocket(id, sockId) {
        ...
        try {
            ...
            log.error("Adding socket: " + ex); status = false;
        }
        return status;
    }
    ...
    removeSocket(id) {
        ...
        try {
            ...
            log.error(" [ERROR] removing socket: " + ex); status = false;
        }
        return status;
    }
    ...
    getConnection(id) {
        ...
        try {
            ...
            log.error("Getting connection: " + ex); ret = null;
        }
        return ret;
    }
